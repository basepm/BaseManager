...
<input type="hidden" id="system_no_access" value="0"/>
	...
	<div class="vd_register-page">
	  ...
	  <div class="panel widget">
	    <div class="panel-body">
	      ...
	      <h1 class="font-semibold text-center" style="font-size:52px">暂无访问权限</h1>
	    <form class="form-horizontal" action="#" role="form">
	      <div class="form-group">
	        <div class="col-md-12">
	          <h4 class="text-center mgbt-xs-20">暂无访问权限。</h4>
